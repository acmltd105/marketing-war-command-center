...
Phases **6+** = expansion (Firestorm merge, lead marketplace, IPO tracker depth, multi-region). Document when Phase 5 closes.

---

*Phases are **capability-based**, not calendar-based.*
